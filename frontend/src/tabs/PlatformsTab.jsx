...
import { validatePlatform } from "../utils/authValidations";
...
export default function PlatformsTab() {
  ...
  const openCreate = () => {
    setForm({ name: "", manufacturer: "", release_date: "" });
    setFormError("");
    setModal("create");
  };
  ...
  const handleSave = async () => {
    ...
    const errors = validatePlatform(form);
                ...
                {platforms.length === 0 ? (
                  ...
                  platforms.map((p, i) => (
                    <TableRow key={p._id} sx={{ bgcolor: i % 2 === 0 ? "white" : "#f5f6f7" }}>
                      ...
                      <TableCell>
                        <ActionBtn color="#27ae60" onClick={() => openEdit(p)}>
                          <EditIcon fontSize="small" />
                        </ActionBtn>
                      </TableCell>
                      <TableCell>
                        <ActionBtn
                          color={p.is_active ? "#e53935" : "#1565c0"}
